...
export const setThemeMode = (mode: 'dark' | 'holo') => ({
  type: 'SETTINGS_SET_THEME_MODE' as const,
  payload: mode,
});

export const setThemeEffects = (effects: 'off' | 'soft' | 'full') => ({
  type: 'SETTINGS_SET_THEME_EFFECTS' as const,
  payload: effects,
});

export const setThemeCheckpoint = (
  checkpoint: 'shell-only' | 'shell-cards' | 'shell-cards-particles'
) => ({
  type: 'SETTINGS_SET_THEME_CHECKPOINT' as const,
  payload: checkpoint,
});

export const setThemeParticlesEnabled = (enabled: boolean) => ({
  type: 'SETTINGS_SET_THEME_PARTICLES' as const,
  payload: enabled,
});
