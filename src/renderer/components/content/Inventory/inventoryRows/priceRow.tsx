      ...
      {settingsData.columns.includes('Price') ? (
        <td className="table-cell px-6 py-3 text-sm text-[var(--text-secondary)] font-medium">
          <div className="flex items-center space-x-2 justify-center rounded-full drop-shadow-lg">
            <div className="flex flex-shrink-0 -space-x-1 text-[var(--text-secondary)] font-normal">
              {formattedPriceCombined}
            </div>
          </div>
          <div className="flex items-center space-x-2 justify-center rounded-full drop-shadow-lg">
            <div className="flex flex-shrink-0 -space-x-1 text-[var(--text-tertiary)] text-xs font-normal">
              {!price ? '' : itemRow.combined_QTY == 1 ? '' : formattedPrice}
            </div>
          </div>
        </td>
      ) : null}
